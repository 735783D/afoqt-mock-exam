...
//   // Memoize shuffled InstComp questions so they don't re-shuffle on every render
//   const shuffledInstCompQuestions = useMemo(() => {
//     if (sectionId === 'instrument-comp' && selectedSubsection && selectedSubsection.startsWith('set-')) {
//       return [...instrumentCompData]
//         .sort(() => Math.random() - 0.5)
//         .slice(0, 25);
//     }
//     return null;
//   }, [sectionId, selectedSubsection]); // Only re-shuffle when subsection changes
...
//       case 'instrument-comp':
//         // Use memoized shuffled questions
//         const instCompQuestions = shuffledInstCompQuestions || instrumentCompData;
...
// // Add this helper function to PracticeMode.js (near the top with other helpers)
...
// // Example usage in getSectionData():
// // const readingCompQs = getReadingCompSet(readingComprehensionData, selectedSubsection, 25);
...
//         const readingCompQs = getReadingCompSet(readingComprehensionData, selectedSubsection, 25);
//         return {
//           data: readingCompQs,  // DON'T map/wrap - already correct format
//           config: READING_COMPREHENSION_CONFIG,
//           name: 'Reading Comprehension',
//           isArithmetic: false,
//           isPassageBased: true
...
//       case 'instrument-comp':
//         // Don't use sequential sets - randomly sample instead
//         const allInstCompQs = [...instrumentCompData];
//         const sampledQuestions = selectedSubsection && selectedSubsection.startsWith('set-')
//           ? allInstCompQs.sort(() => Math.random() - 0.5).slice(0, 25)  // Random 25
//           : allInstCompQs;  // Or all 200 for full practice
          
//         return {
//           data: sampledQuestions.map(q => ({
//             id: q.id,
//             questions: [q]
//           })),
//           config: INSTRUMENT_COMP_CONFIG,
