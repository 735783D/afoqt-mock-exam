...
export const wordKnowledgeData = [
  {
    id: 1,
    text: "Supplant most nearly means:",
    options: ["Amplify", "Clarify", "Uproot", "Stabilize"],
    correct: 2,
    explanation: "To supplant means to take the place of or uproot something."
  },
  {
    id: 2,
    text: "Vagary most nearly means:",
    options: ["Limitless", "Wispy", "Capable", "Caprice"],
    correct: 3,
    explanation: "A vagary is an unpredictable or whimsical idea or action, similar to a caprice."
  },
  {
    id: 3,
    text: "Calamari most nearly means:",
    options: ["Shamu", "Digit", "Squid", "Matrimony"],
    correct: 2,
    explanation: "Calamari is a dish made from squid."
  },
  {
    id: 4,
    text: "Lethargic most nearly means:",
    options: ["Apathetic", "Cozy", "Bouncy", "Deadly"],
    correct: 0,
    explanation: "Lethargic means sluggish or without energy, similar to apathetic."
  },
  {
    id: 5,
    text: "Teensy most nearly means:",
    options: ["Adolescent", "Immature", "Tiny", "Feminine"],
    correct: 2,
    explanation: "Teensy means very small or tiny."
  },
  {
    id: 6,
    text: "Audible most nearly means:",
    options: ["Visible", "Heard", "Silent", "Distant"],
    correct: 1,
    explanation: "Audible means capable of being heard."
  },
  {
    id: 7,
    text: "Eloquent most nearly means:",
    options: ["Graceful", "Silent", "Persuasive", "Vague"],
    correct: 2,
    explanation: "Eloquent refers to fluent and persuasive speech."
  },
  {
    id: 8,
    text: "Imminent most nearly means:",
    options: ["Faraway", "Pending", "Avoidable", "Impossible"],
    correct: 1,
    explanation: "Imminent means about to happen or forthcoming."
  },
  {
    id: 9,
    text: "Diligent most nearly means:",
    options: ["Careless", "Hardworking", "Impatient", "Curious"],
    correct: 1,
  ...
  },
  {
    ...
    options: ["Important", "Minor", "Complex", "Ancient"],
    correct: 1,
    explanation: "Trivial means of little value or importance."
  },
  {
    id: 11,
    text: "Verbose most nearly means:",
    options: ["Wordy", "Quiet", "Strong", "Thoughtful"],
    correct: 0,
  ...
  },
  {
    ...
    options: ["Forgetful", "Determined", "Gentle", "Shy"],
    correct: 1,
    explanation: "Tenacious means holding firm or being persistent."
  },
  {
    id: 13,
    text: "Benevolent most nearly means:",
    options: ["Kind", "Wealthy", "Clever", "Dangerous"],
    correct: 0,
  ...
  },
  {
    ...
    options: ["Threatening", "Peaceful", "Bright", "Dull"],
    correct: 0,
    explanation: "Ominous means giving the impression something bad is going to happen."
  },
  {
    id: 15,
    text: "Candid most nearly means:",
    options: ["Hidden", "Honest", "Angry", "Uncertain"],
    correct: 1,
    explanation: "Candid means truthful and straightforward."
  },
  {
    id: 16,
    text: "Succinct most nearly means:",
    options: ["Brief", "Elaborate", "Tense", "Polite"],
    correct: 0,
  ...
  },
  {
    ...
    options: ["Submissive", "Wild", "Clever", "Proud"],
    correct: 0,
    explanation: "Docile means easily taught or managed; submissive."
  },
  {
    id: 20,
    text: "Frugal most nearly means:",
    options: ["Generous", "Careful", "Wealthy", "Extravagant"],
    correct: 1,
    explanation: "Frugal means economical or avoiding waste."
  },
  {
    id: 21,
    text: "Copious most nearly means:",
    options: ["Sparse", "Abundant", "Ordinary", "Limited"],
    correct: 1,
    explanation: "Copious means large in quantity or plentiful."
  },
  {
    id: 22,
  ...
  },
  {
    ...
    options: ["Sad", "Joyful", "Tired", "Cautious"],
    correct: 1,
    explanation: "Jubilant means showing great happiness or triumph."
  },
  {
    id: 24,
    text: "Nefarious most nearly means:",
    options: ["Evil", "Boring", "Sneaky", "Loyal"],
    correct: 0,
  ...
  },
  {
    id: 25,
    text: "Meticulous most nearly means:",
    options: ["Careless", "Thorough", "Fast", "Secretive"],
    correct: 1,
  ...
  {
    id: 29,
    text: "Impetuous most nearly means:",
    options: ["Hasty", "Patient", "Careful", "Planned"],
    correct: 0,
  ...
  },
  {
    id: 33,
    text: "Eloquent most nearly means:",
    options: ["Persuasive", "Quiet", "Dull", "Boastful"],
    correct: 0,
  ...
  {
    id: 37,
    text: "Conspicuous most nearly means:",
    options: ["Noticeable", "Hidden", "Quiet", "Subtle"],
    correct: 0,
    explanation: "Conspicuous means standing out so as to be clearly visible."
  },
  {
    id: 38,
    text: "Docile most nearly means:",
  ...
  {
    id: 41,
    text: "Scrutinize most nearly means:",
    options: ["Examine closely", "Ignore", "Forget", "Reject"],
    correct: 0,
    explanation: "Scrutinize means to inspect or examine closely and thoroughly."
  },
  {
    id: 42,
    text: "Diligent most nearly means:",
  ...
  },
  {
    id: 45,
    text: "Candid most nearly means:",
    options: ["Honest", "Deceptive", "Quiet", "Formal"],
    correct: 0,
    explanation: "Candid means truthful and straightforward."
  },
  {
  ...
  {
    id: 49,
    text: "Nostalgia most nearly means:",
    options: ["Longing", "Hatred", "Anger", "Contentment"],
    correct: 0,
    explanation: "Nostalgia means sentimental longing for the past."
  },
  {
    id: 50,
  ...
  },
  {
    ...
    options: ["Overjoyed", "Sad", "Angry", "Nervous"],
    correct: 0,
    explanation: "Elated means extremely happy or proud."
  },
  {
    id: 54,
  ...
  {
    id: 61,
    text: "Eminent most nearly means:",
    options: ["Distinguished", "Ordinary", "Unknown", "Silent"],
    correct: 0,
    explanation: "Eminent means famous or respected within a profession."
  },
  {
    id: 62,
  ...
  {
    id: 65,
    text: "Pragmatic most nearly means:",
    options: ["Practical", "Idealistic", "Dreamy", "Naive"],
    correct: 0,
  ...
  {
    id: 69,
    text: "Prolific most nearly means:",
    options: ["Productive", "Sparse", "Limited", "Slow"],
    correct: 0,
    explanation: "Prolific means producing much fruit, foliage, or many works."
  },
  {
    id: 70,
  ...
  {
    id: 73,
    text: "Apathy most nearly means:",
    options: ["Indifference", "Passion", "Fear", "Excitement"],
    correct: 0,
  ...
  {
    id: 76,
    text: "ADMIRE is to RESPECT as DETEST is to",
    options: ["LOVE", "HATE", "FEAR", "TOLERATE", "AVOID"],
    correct: 1,
    explanation: "To ADMIRE someone is to RESPECT them; to DETEST someone is to HATE them."
  },
  {
    id: 77,
    text: "MOUNTAIN is to ELEVATION as VALLEY is to",
    options: ["DEPTH", "PEAK", "RIDGE", "PLAIN", "HEIGHT"],
    correct: 0,
    explanation: "A MOUNTAIN has high ELEVATION; a VALLEY has great DEPTH."
  },
  {
    id: 78,
    text: "FIRE is to HEAT as ICE is to",
    options: ["COLD", "FREEZE", "CHILL", "FROST", "WATER"],
    correct: 0,
    explanation: "FIRE produces HEAT; ICE produces COLD."
  },
  {
    id: 79,
    text: "NOVEL is to AUTHOR as SYMPHONY is to",
    options: ["CONDUCTOR", "MUSICIAN", "COMPOSER", "BAND", "INSTRUMENT"],
    correct: 2,
  ...
  },
  {
    ...
    options: ["FOOT", "LEG", "KNEE", "ANKLE", "SOLE"],
    correct: 0,
    explanation: "A FINGER is part of a HAND; a TOE is part of a FOOT."
  },
  {
    id: 81,
    text: "ENEMY is to HOSTILE as FRIEND is to",
    options: ["TRUST", "LOYAL", "KIND", "ALLY", "FRIENDLY"],
    correct: 4,
    explanation: "An ENEMY is HOSTILE; a FRIEND is FRIENDLY."
  },
  {
    id: 82,
  ...
  {
    id: 84,
    text: "DAY is to SUN as NIGHT is to",
    options: ["DARK", "MOON", "LIGHT", "STARS", "SLEEP"],
    correct: 1,
    explanation: "The SUN is seen during DAY; the MOON is seen at NIGHT."
  },
  {
    id: 85,
    text: "CAPTAIN is to SHIP as PILOT is to",
    options: ["JET", "FLIGHT", "PLANE", "AIR", "COCKPIT"],
    correct: 2,
    explanation: "A CAPTAIN commands a SHIP; a PILOT commands a PLANE."
  },
  {
    id: 86,
    text: "WHEEL is to CAR as WING is to",
    options: ["PLANE", "BIRD", "SKY", "JET", "AIR"],
    correct: 0,
    explanation: "A WHEEL helps a CAR move; a WING helps a PLANE move."
  },
  {
    id: 87,
  ...
  {
    id: 89,
    text: "PRISON is to CONVICT as SCHOOL is to",
    options: ["STUDENT", "TEACHER", "CLASS", "EDUCATION", "LEARNING"],
    correct: 0,
    explanation: "A CONVICT is kept in PRISON; a STUDENT attends SCHOOL."
  },
  {
    id: 90,
    text: "RAINBOW is to COLORS as CHORD is to",
    options: ["SOUNDS", "MUSIC", "INSTRUMENTS", "NOTES", "MELODY"],
    correct: 3,
  ...
  },
  {
    ...
    options: ["NAVY", "SEA", "BOAT", "CAPTAIN", "MARINE"],
    correct: 0,
    explanation: "A SOLDIER belongs to an ARMY; a SAILOR belongs to the NAVY."
  },
  {
    id: 92,
    text: "JUDGE is to COURT as TEACHER is to",
    options: ["LESSON", "CLASSROOM", "BOOK", "EXAM", "STUDENT"],
    correct: 1,
    explanation: "A JUDGE works in a COURT; a TEACHER works in a CLASSROOM."
  },
  {
    id: 93,
    text: "SPEAR is to THROW as BOW is to",
    options: ["STRING", "ARROW", "TARGET", "SHOOT", "AIM"],
    correct: 3,
    explanation: "You THROW a SPEAR; you SHOOT a BOW."
  },
  {
    id: 94,
  ...
  {
    id: 97,
    text: "FUEL is to ENGINE as FOOD is to",
    options: ["BODY", "ENERGY", "STOMACH", "LIFE", "HEALTH"],
    correct: 0,
    explanation: "FUEL powers an ENGINE; FOOD powers the BODY."
  },
  {
    id: 98,
    text: "LAWYER is to CLIENT as DOCTOR is to",
    options: ["PATIENT", "NURSE", "MEDICINE", "CASE", "HOSPITAL"],
    correct: 0,
    explanation: "A LAWYER serves a CLIENT; a DOCTOR serves a PATIENT."
  },
  {
    id: 99,
    text: "GRAIN is to WHEAT as GEM is to",
    options: ["JEWEL", "STONE", "DIAMOND", "ROCK", "MINERAL"],
    correct: 2,
    explanation: "WHEAT is a type of GRAIN; a DIAMOND is a type of GEM."
  },
  {
    id: 100,
  ...
  },
  {
    id: 137,
    text: "ABERRATION",
    options: ["normality", "deviation", "habit", "rule", "pattern"],
    correct: 1,
    explanation: "Aberration means a deviation from what is normal or expected."
  },
  {
    id: 138,
    text: "INTRANSIGENT",
  ...
  },
  {
    id: 141,
    text: "DISPARAGE",
    options: ["praise", "belittle", "improve", "support", "assist"],
    correct: 1,
    explanation: "Disparage means to belittle or speak of someone in a derogatory manner."
  },
  {
    id: 142,
    text: "EPITOME",
    options: ["extreme", "summary", "symbol", "example", "copy"],
    correct: 3,
    explanation: "Epitome means a perfect example of a quality or type."
  },
  {
    id: 143,
    text: "OBFUSCATE",
  ...
  },
  {
    id: 145,
    text: "NEFARIOUS",
    options: ["honorable", "wicked", "famous", "brave", "lawful"],
    correct: 1,
    explanation: "Nefarious means wicked or villainous."
  },
  {
    id: 146,
    text: "PROLIFIC",
  ...
  },
  {
    id: 149,
    text: "QUIXOTIC",
    options: ["practical", "idealistic", "boring", "rational", "stable"],
    correct: 1,
    explanation: "Quixotic means extremely idealistic or unrealistic."
  },
  {
    id: 150,
    text: "DEFERENCE",
  ...
  },
  {
    id: 154,
    text: "SANCTIMONIOUS",
    options: ["pious", "hypocritically moralistic", "genuine", "sinful", "humble"],
    correct: 1,
    explanation: "Sanctimonious means pretending to be morally superior."
  },
  {
    id: 155,
    text: "EQUIVOCAL",
  ...
  },
  {
    id: 161,
    text: "BELLICOSE",
    options: ["peaceful", "warlike", "calm", "gentle", "relaxed"],
    correct: 1,
    explanation: "Bellicose means demonstrating aggression or a willingness to fight."
  },
  {
    id: 162,
    text: "ALACRITY",
  ...
  },
  {
    id: 165,
    text: "ABATE",
    options: ["increase", "lessen", "continue", "harden", "begin"],
    correct: 1,
    explanation: "Abate means to reduce in degree or intensity."
  },
  {
    id: 166,
    text: "PROSAIC",
  ...
  },
  {
    id: 173,
    text: "RECONDITE",
    options: ["simple", "obscure", "known", "basic", "clear"],
    correct: 1,
    explanation: "Recondite means little known or obscure."
  },
  {
    id: 174,
    text: "PARAGON",
  ...
  },
  {
    id: 177,
    text: "DISSEMINATE",
    options: ["collect", "spread", "ignore", "block", "limit"],
    correct: 1,
    explanation: "Disseminate means to spread or disperse widely."
  },
  {
    id: 178,
    text: "INNOCUOUS",
  ...
  },
  {
    id: 181,
    text: "OSTENTATIOUS",
    options: ["modest", "showy", "plain", "humble", "simple"],
    correct: 1,
    explanation: "Ostentatious means characterized by vulgar or pretentious display."
  },
  {
  ...
  },
  {
    id: 192,
    text: "INSOLVENT",
    options: ["wealthy", "bankrupt", "generous", "rich", "stable"],
    correct: 1,
