            ...
            {examData.map((item, itemIndex) => {
              ...
              return (
                <div key={item.id || itemIndex}>
                  ...
                  {questions.map(q => {
                    // Skip questions without options (like self-description or situational judgment)
                    if (!q.options || !Array.isArray(q.options)) {
                      return (
                        <div key={q.id} className="mb-6 p-4 rounded-lg border-2 bg-gray-50 border-gray-300">
                          <p className="text-sm text-gray-600 italic">
                            Question {q.id}: Results not available for this question type
                          </p>
                        </div>
                      );
                    }
                    ...
                    const isImageOption = typeof q.options[0] === 'string' && q.options[0].includes('/images/');
                          ...
                          <div className="flex-grow">
                            ...
                            {isImageOption ? (
                              <>
                                ...
                                {!isCorrect && correctAnswerIndex !== undefined && q.options[correctAnswerIndex] && (
                                  <div className="mb-2">
