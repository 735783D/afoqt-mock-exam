...
// import { ArrowLeft, BookOpen, Calculator, Brain, Plane } from 'lucide-react';
...
//       id: 'word-problems',
//       name: 'Word Problems',
//       description: 'Distance, time, work, and rate problems',
//       questions: 25,
//       icon: Calculator
//     },
//     {
...
//       id: 'geometry',
//       name: 'Geometry',
//       description: 'Area, perimeter, volume, and angles',
//       questions: 25,
//       icon: Calculator
//     }
//   ]
...
//             Each subsection contains 25-30 questions focused on a specific topic area. 
...
const subsectionData = {
  ...
  'math-knowledge': [
    ...
    ...generateNumberedSets(200, 25, Brain) // Generate Set 1, Set 2, etc.
  ],
  ...
  'aviation-info': [
    {
      ...
      description: 'Components, engines, and flight controls',
      questions: 50,
      icon: Plane
    },
    {
      ...
      description: 'Flight rules, airspace, and operations',
      questions: 50,
      icon: Plane
    },
    ...generateNumberedSets(200, 25, Plane)
  ],
  'physical-science': [
    {
      id: 'physics',
    ...
    ...generateNumberedSets(200, 25, Beaker)
  ],
  ...
  'situational-judgment': generateNumberedSets(200, 25, Users) // 25 scenarios per set
};
