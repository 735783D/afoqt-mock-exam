        ...
        <div className="bg-white rounded-lg shadow-xl p-8 mb-6">
          ...
          <div className="mb-6">
            <h3 className="text-2xl font-bold text-gray-900 mb-2">
              Block Counting - Question {currentQuestion.id}
            </h3>
          ...
          <div className="grid grid-cols-2 gap-4 mb-6">
            {currentQuestion.options.map((option, index) => (
              <div
                ...
                className={`cursor-pointer border-4 rounded-lg p-6 transition-all ${
              ...
              >
                <div className="flex items-center gap-4">
                  <div className="flex-shrink-0 w-12 h-12 rounded-full bg-gray-700 text-white flex items-center justify-center font-bold text-lg">
