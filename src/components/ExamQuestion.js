...
import { getDiagram } from './MathDiagrams';
    ...
    <div className="min-h-screen bg-gray-100 pb-8">
      <div className="max-w-6xl mx-auto p-4 md:p-8">
        <div className="bg-white rounded-lg shadow-lg p-6 md:p-10 mb-6">
          {/* Show passage section for reading comp */}
          {isPassageBased && passage.passage ? (
            <>
          ...
          <div className="space-y-8">
            {passage.questions.map((question) => (
              <div key={question.id} className={isPassageBased ? "pt-6" : ""}>
                {/* Show question text without ID number */}
                ...
                {question.diagram && (
                  <div className="my-6 flex justify-center bg-gray-50 p-6 rounded-lg border border-gray-200">
                    {getDiagram(question.diagram.type, question.diagram.props)}
                  </div>
                )}
...
//             </>
//           ) : (
//             /* Show Question header for non-passage sections */
...
//             {passage.questions.map((question) => (
//               <div key={question.id} className={isPassageBased ? "pt-6" : ""}>
//                 {/* Show "Question X:" prefix ONLY for passage-based (reading comp) */}
//                 <h3 className="font-semibold text-lg mb-4 text-gray-900">
//                   {isPassageBased ? `Question ${question.id}: ${question.text}` : question.text}
//                 </h3>
...
//                 <h3 className="font-semibold text-lg mb-4 text-gray-900">
//                   {isArithmetic ? question.text : `Question ${question.id}: ${question.text}`}
//                 </h3>
